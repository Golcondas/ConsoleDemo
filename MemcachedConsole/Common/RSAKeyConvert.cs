...
{
    /// <summary>/// RSA密钥格式转换/// </summary>
    public class RSAKeyConvert
    {
        /// <summary>    /// RSA私钥格式转换，java->.net    
        /// </summary>    
        /// <param name="privateKey">java生成的RSA私钥</param>    /// <returns></returns>    
        ...
        /// <summary>    /// RSA私钥格式转换，.net->java    /// </summary>    
        ...
        {
            XmlDocument doc = new XmlDocument(); doc.LoadXml(privateKey);
        ...
        /// <summary>    
        /// RSA公钥格式转换，java->.net    /// </summary>    
        /// <param name="publicKey">java生成的公钥</param>    /// <returns></returns>    
        ...
        /// <summary>    /// RSA公钥格式转换，.net->java    /// </summary>    
